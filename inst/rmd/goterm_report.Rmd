...
| `Count`              | [ensembl.org](https://www.ensembl.org/info/genome/stable_ids/index.html) number of significant genes associated with GO-term (extracted from `GeneRatio`).]    |
| `PercentSignificant` | [ensembl.org](https://www.ensembl.org/info/genome/stable_ids/index.html) Percentage of differentially expressed genes of the GO-term]                          |
