...
tibble::tibble(
  ...
  setting = c(params$output_path, params$save_excel, params$significance_cutoff, params$simplify_ontologies, params$do_gse, params$use_background)
) %>%
  knitr::kable()
...
params$dat %>%
  head() %>%
  knitr::kable()
paste0("dat contains ", params$dat %>% nrow(), " rows.")
