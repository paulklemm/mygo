...
```{r get_go_and_gse}
# Load the data from disk in dev mode to speed up the debugging process
if (params$dev) {
  load('/beegfs/scratch/bruening_scratch/pklemm/rpackages/mygo/test/terms.Rdata')
} else {
